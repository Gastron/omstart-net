...
parser.add_argument('--train-data', type=str, default='./data/tokenized/wappulehti.all.tokens',
                    help='location of the data corpus')
parser.add_argument('--dev-data', type=str, default='./data/tokenized/wappulehti.all.tokens',
        help = 'localtion of dev data')
...
eval_batch_size = 10
train_dataset = data.InMemoryTextDataSet(args.train_data)
val_dataset = data.InMemoryTextDataSet(args.dev_data)
    ...
    for batch_i, (inputs, targets, seq_lengths) in enumerate(train_gen):
        ...
        if batch_i % args.log_interval == 0 and batch_i > 0:
            ...
            print('| epoch {:3d} | {:5d}/{:5d} batches | lr {:02.2f} | ms/batch {:5.2f} | '
                ...
                epoch, batch_i, len(train_dataset) // args.batch_size, lr,

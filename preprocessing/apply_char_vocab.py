...
if __name__ == "__main__":
    ...
    parser.add_argument("--unk", default = "<unk>", help = "token for character not in the vocabulary")
    ...
    for line in fileinput.input(args.input):
        ...
        mapped_sentence = [vocab[args.start_symbol]] + mapped_sentence + [vocab[args.end_symbol]]
        print(" ".join(mapped_sentence))
